...
//            forControlEvents:UIControlEventTouchUpInside] ;
        UITapGestureRecognizer *potoRecognizer = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(backgroundClicked:)];
        [_bgButton addGestureRecognizer:potoRecognizer];
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [_imgView addGestureRecognizer:potoRecognizer];
    }
...
- (void)backgroundClicked:(UITapGestureRecognizer *)gesture
{
    [self.delegate handleTapGestureRecognizer:gesture];
    [self clearAllOnFirst] ;
}
